...
import rdsImage from "./Arch_Amazon-RDS_64.png"
import { AWSIconBase, AWSIconBaseProps, defaultProps } from "./aws-icon-base";

export interface RDSMultiAZProps extends AWSIconBaseProps {
    
}

export class RDSMultiAZ extends AWSIconBase {

    public constructor(props?: RDSMultiAZProps) {
        super({
            ...defaultProps(props),
        });
