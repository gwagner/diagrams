...
import { WAF } from "valewood-components/cloud/aws/waf";
...
export class WAFRef extends BaseRef implements AwsLandscapeComponentRef  {

    private _ref: Reference<WAF>;
    public get ref(): Reference<WAF> {
        return this._ref;
    }
    private set ref(value: Reference<WAF>) {
        this._ref = value;
    }

    constructor(props: AWSLandscapeProps) {
        super(props)
        this._ref = createRef<WAF>();
    ...
    setup()  {
        return (<WAF ref={this.ref} fontSize={this.props.fontSize} tags={this.tags} />)
    }
